...
/* harmony export */   "default": () => (__WEBPACK_DEFAULT_EXPORT__)
/* harmony export */ });
var styler_js = function styler_js(_ref) {
  var sal = _ref.sal,
      Glide = _ref.Glide,
      feather = _ref.feather;
  // Start sal
  sal(); // Start Glide

  var glide = document.querySelectorAll("#glide .glide__slide");
...
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = (styler_js);
...
var feather = __webpack_require__(/*! feather-icons */ "./node_modules/feather-icons/dist/feather.js"); // Init main js



var plugins = {
  sal: (sal_js__WEBPACK_IMPORTED_MODULE_1___default()),
  Glide: _glidejs_glide__WEBPACK_IMPORTED_MODULE_2__["default"],
  feather: feather
}; // Init when dom loaded

window.addEventListener('DOMContentLoaded', (0,_main__WEBPACK_IMPORTED_MODULE_3__["default"])(plugins));
...
/******/ 		}
/******/ 		
/******/ 		var chunkLoadingGlobal = self["webpackChunkstyler"] = self["webpackChunkstyler"] || [];
